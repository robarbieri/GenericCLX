...
<body>
    <form id="form1" runat="server">
        <ajaxToolkit:ToolkitScriptManager runat="Server" ID="ScriptMgr1">
        ...
        <br />
             ...
             ID="Panel1" runat="server">
                <asp:Panel ID="Panel3" runat="Server">
                   <p>
                    ...
                    <ajaxToolkit:CollapsiblePanelExtender runat="server" ID="verticalCP" TargetControlID="verticalPanel"
            ...
            <ajaxToolkit:CollapsiblePanelExtender runat="server" ID="collapsiblePanel1" ExpandDirection="Horizontal"
