<%@ Page Language="C#" AutoEventWireup="true" Title="Test of Duplicate StyleSheet references" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajax" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Test Of Duplicate StyleSheet references</title>
</head>
<body>
    <form runat="server" id="frmMP">
        <ajaxToolkit:ToolkitScriptManager ID="scmMain" EnablePartialRendering="true" runat="server" />
